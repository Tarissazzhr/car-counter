...
# Tracking
tracker = Sort(max_age=20, min_hits=3, iou_threshold=0.5)  # Adjusted IOU threshold
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if currentClass in ["car", "truck", "bus"] and conf > 0.5:  # Adjusted confidence threshold
